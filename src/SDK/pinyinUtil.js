 ...
 * @last 2016-09-29
 */
import pinyinDictNotone from "./dict/pinyin_dict_notone";
import pinyinDictWithtone from "./dict/pinyin_dict_withtone";
window.pinyin_dict_notone = pinyinDictNotone.pinyin_dict_notone;
window.pinyin_dict_withtone = pinyinDictWithtone.pinyin_dict_withtone;
;(function()
{
	var dict = {}; // 存储所有字典数据
	var pinyinUtil =
	{
		...
		parseDict: function()
		{
			...
			if(window.pinyin_dict_notone)
			{
				...
				for(var i in window.pinyin_dict_notone)
				{
					var temp = window.pinyin_dict_notone[i];
			...
			{
				dict.withtone = {};
				var temp = window.pinyin_dict_withtone.split(',');
				...
				else
				{
					...
					var notone = pinyinUtil.removeTone(window.pinyin_dict_withtone).split(',');
					var py2hz = {}, py, hz;
